            ...
            '<div class="container-fluid">' + 
                '<div class="row">' + 
                    ...
                    '<div id="WrapData" class="col-sm-4 col-md-4">' + 
                        ...
                        '<div id="DivBestColStep" class="textGame best">Лучший результат: ' + preload.BestColStep + ' шагов</div>' +
                        '' +
    ...
    */
    ...
    var target = {
        ...
        "f_create": function(){
            ...
            target.X = floor.XLeft + preload.BlockWidth * 3;
            ...
            target.X = floor.XRight - preload.BlockWidth * 4;
            target.Y = floor.YTop;
    ...
    var box = {
        ...
        "f_create": function(){
            ...
            box.X = floor.XLeft + preload.BlockWidth * 1;
            box.Y = floor.YBottom - preload.BlockHeight * 5;
            box.block[2] = new f_BuildingBlock(box.X, box.Y, "box-2", "crate_04.png", "box");
            box.block[2].Div.style.zIndex = 300;    
            
            box.X = floor.XRight - preload.BlockWidth * 2;
            box.Y = floor.YBottom - preload.BlockHeight * 5;
            box.block[3] = new f_BuildingBlock(box.X, box.Y, "box-2", "crate_04.png", "box");
            box.block[3].Div.style.zIndex = 300;       
            
            box.X = floor.XRight - preload.BlockWidth * 3;
            box.Y = floor.YBottom - preload.BlockHeight * 3;
            box.block[4] = new f_BuildingBlock(box.X, box.Y, "box-2", "crate_04.png", "box");
    ...
    var inWall = {
        ...
        "f_build": function(){
            ...
            inWall.Y = floor.YBottom - preload.BlockHeight;
            ...
            inWall.X = floor.XRight - preload.BlockWidth * 4;
            ...
            inWall.X = floor.XLeft + preload.BlockWidth * 3;
            inWall.Y = floor.YBottom - preload.BlockHeight * 4;
            inWall.block[6] = new f_BuildingBlock(inWall.X, inWall.Y, "inwall-6", "block_08.png", "inwall");   
            
            inWall.X = floor.XRight - preload.BlockWidth * 5;
            inWall.Y = floor.YTop  + preload.BlockHeight * 2;
...
preload.nextLvl.onclick = function(){
    window.location.href = '/lvl/8QTvKbCSX.php';
};
