...
--------------------------------------------------------------------------------------------------------------------------*/
    ...
    */
    function f_BuildingBlock(x=50, y=50, divName = "block-", img = "environment_06.png", tip = "wall"){     
        ...
        //this.Div.style.transition = "all linear 0.6s";
    ...
    var target = {
        ...
        "f_create": function(){
            ...
            target.X = floor.XRight - preload.BlockWidth * 3;
            target.Y = floor.YTop + preload.BlockHeight * 2;
            target.block = new f_BuildingBlock(target.X, target.Y, "target-1", "crate_27.png", "target");
        },
    };
    // -------------------------------------------------------------------
    ...
    var box = {
        ...
        "f_create": function(){
            ...
            box.block[2] = new f_BuildingBlock(box.X, box.Y, "box-2", "crate_05.png", "box");  
    ...
    var inWall = {
        ...
        "f_build": function(){
            ...
            inWall.X = floor.XRight - preload.BlockWidth;
            ...
            inWall.X = floor.XRight - preload.BlockWidth * 2;
            inWall.Y = floor.YBottom - preload.BlockHeight * 3;
...
addEventListener("keydown", function(event) {  
    ...
    if (preload.DetectKey == "keyup"){                          
        ...
        // игрок выиграл
        if (target.block.X == box.block[0].X && target.block.Y == box.block[0].Y){
...
function f_sizeWindow (){
    ...
    // -- конечная цель ящика --
        target.block.X = target.block.X + differX;
        target.block.Y = target.block.Y + differY;
        target.block.Div.style.left = target.block.X + "px";
        target.block.Div.style.top = target.block.Y + "px";
    // -- -- --
};
/* -------------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------
...
preload.nextLvl.onclick = function(){
    window.location.href = '/lvl/3OtSqpqmF.php';
};
