    ...
    */
    ...
    var target = {
        ...
        "f_create": function(){
            ...
            target.X = floor.XLeft + preload.BlockWidth * 2;
            target.Y = floor.YTop;
            target.block[0] = new f_BuildingBlock(target.X, target.Y, "target-0", "crate_27.png", "target");
            
            target.X = floor.XLeft + preload.BlockWidth * 2;
            target.Y = floor.YBottom - preload.BlockHeight;
    ...
    var box = {
        ...
        "f_create": function(){
            ...
            box.X = floor.XRight - preload.BlockWidth * 2;
            box.Y = floor.YBottom - preload.BlockHeight * 4;
            ...
            box.X = floor.XLeft + preload.BlockWidth * 5;
            box.Y = floor.YBottom - preload.BlockHeight;
            box.block[2] = new f_BuildingBlock(box.X, box.Y, "box-2", "crate_04.png", "box");
            box.block[2].Div.style.zIndex = 300;    
            
            box.X = floor.XRight - preload.BlockWidth;
            box.Y = floor.YTop + preload.BlockHeight;
            box.block[3] = new f_BuildingBlock(box.X, box.Y, "box-3", "crate_04.png", "box");
            box.block[3].Div.style.zIndex = 300; 
            
            box.X = floor.XRight - preload.BlockWidth * 3;
            box.Y = floor.YTop + preload.BlockHeight;
            box.block[4] = new f_BuildingBlock(box.X, box.Y, "box-4", "crate_04.png", "box");
            box.block[4].Div.style.zIndex = 300;      
            
            box.X = floor.XRight - preload.BlockWidth * 3;
            box.Y = floor.YTop + preload.BlockHeight * 4;
            box.block[5] = new f_BuildingBlock(box.X, box.Y, "box-5", "crate_04.png", "box");
            box.block[5].Div.style.zIndex = 300;              
    ...
    var inWall = {
        ...
        "f_build": function(){
            ...
            inWall.X = floor.XLeft + preload.BlockWidth * 3;
            ...
            inWall.X = floor.XLeft + preload.BlockWidth * 4;
            inWall.Y = floor.YTop + preload.BlockHeight * 3;
            ...
            inWall.X = floor.XLeft + preload.BlockWidth * 4;
            inWall.Y = floor.YTop + preload.BlockHeight * 1;
            ...
            inWall.X = floor.XLeft + preload.BlockWidth * 1;
            inWall.Y = floor.YTop + preload.BlockHeight * 1;
            ...
            inWall.block[8] = new f_BuildingBlock(inWall.X, inWall.Y, "inwall-8", "block_08.png", "inwall");     
            
            inWall.X = floor.XLeft + preload.BlockWidth * 6;
            inWall.Y = floor.YTop + preload.BlockHeight * 2;
            inWall.block[9] = new f_BuildingBlock(inWall.X, inWall.Y, "inwall-9", "block_08.png", "inwall");   
            
            inWall.X = floor.XLeft + preload.BlockWidth * 3;
            inWall.Y = floor.YTop + preload.BlockHeight * 3;
            inWall.block[10] = new f_BuildingBlock(inWall.X, inWall.Y, "inwall-10", "block_08.png", "inwall");
            
            
            inWall.X = floor.XLeft + preload.BlockWidth * 4;
            inWall.Y = floor.YBottom - preload.BlockHeight * 2;
            inWall.block[11] = new f_BuildingBlock(inWall.X, inWall.Y, "inwall-11", "block_08.png", "inwall");    
            
            
            inWall.X = floor.XLeft + preload.BlockWidth * 3;
            inWall.Y = floor.YBottom - preload.BlockHeight * 2;
            inWall.block[12] = new f_BuildingBlock(inWall.X, inWall.Y, "inwall-12", "block_08.png", "inwall");     
            
            inWall.X = floor.XLeft + preload.BlockWidth * 2;
            inWall.Y = floor.YBottom - preload.BlockHeight * 2;
            inWall.block[13] = new f_BuildingBlock(inWall.X, inWall.Y, "inwall-13", "block_08.png", "inwall");     
            
            inWall.X = floor.XLeft + preload.BlockWidth * 1;
            inWall.Y = floor.YBottom - preload.BlockHeight * 2;
            inWall.block[14] = new f_BuildingBlock(inWall.X, inWall.Y, "inwall-14", "block_08.png", "inwall");      
            
            inWall.X = floor.XLeft + preload.BlockWidth * 1;
            inWall.Y = floor.YBottom - preload.BlockHeight * 3;
            inWall.block[15] = new f_BuildingBlock(inWall.X, inWall.Y, "inwall-15", "block_08.png", "inwall");     
            
            inWall.X = floor.XLeft + preload.BlockWidth * 6;
            inWall.Y = floor.YBottom - preload.BlockHeight * 3;
            inWall.block[16] = new f_BuildingBlock(inWall.X, inWall.Y, "inwall-16", "block_08.png", "inwall");             
        },
    };
    // -------------------------------------------------------------------     
...
preload.prevLvl.onclick = function(){
    window.location.href = '/lvl/7CuekdQqs.php';
};
