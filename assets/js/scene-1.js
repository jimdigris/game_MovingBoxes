    ...
    */
    ...
    var player = {
        ...
        "f_create": function(){
            ...
            player.X = floor.XLeft + preload.BlockWidth * 2;
            player.Y = floor.YTop + preload.BlockHeight * 4;
...
preload.nextLvl.onclick = function(){
    window.location.href = '/lvl/2UYuCWtNL.php';
};
