    ...
    */
    ...
    var target = {
        ...
        "f_create": function(){
            ...
            target.Y = floor.YTop + preload.BlockHeight;
    ...
    var box = {
        ...
        "f_create": function(){
            ...
            box.X = floor.XLeft + preload.BlockWidth * 4;
            box.Y = floor.YTop + preload.BlockHeight * 2;
    ...
    var player = {
        ...
        "f_create": function(){
            ...
            player.X = floor.XLeft + preload.BlockHeight * 2;
            player.Y = floor.YBottom - preload.BlockHeight * 2;
    ...
    var inWall = {
        ...
        "f_build": function(){
            ...
            inWall.X = floor.XLeft + preload.BlockWidth;
            inWall.Y = floor.YTop + preload.BlockHeight * 2;
            ...
            inWall.X = floor.XLeft + preload.BlockWidth * 5;
            inWall.Y = floor.YTop + preload.BlockHeight * 2;
...
preload.prevLvl.onclick = function(){
    window.location.href = '/lvl/5qRjYDYJC.php';
};
